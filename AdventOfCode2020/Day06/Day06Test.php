<?php 
namespace mikeroq\AdventOfCode\AdventOfCode2020\Day06;
...
final class Day06Test extends TestCase
{
    ...
    {
        $Day06 = new Day06();
        $Day06->importInput('AdventOfCode2020/Day06/test_input.txt');
    ...
    {
        $Day06 = new Day06();
        $Day06->importInput('AdventOfCode2020/Day06/input.txt');
