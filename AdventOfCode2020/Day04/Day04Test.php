<?php 
namespace mikeroq\AdventOfCode\AdventOfCode2020\Day04;
...
final class Day04Test extends TestCase
{
    ...
    {
        $Day04 = new Day04();
        $Day04->importInput('AdventOfCode2020/Day04/test_input.txt');
    ...
    {
        $Day04 = new Day04();
        $Day04->importInput('AdventOfCode2020/Day04/test_valid_passports.txt');
    ...
    {
        $Day04 = new Day04();
        $Day04->importInput('AdventOfCode2020/Day04/test_invalid_passports.txt');
    ...
    {
        $Day04 = new Day04();
        $Day04->importInput('AdventOfCode2020/Day04/input.txt');
