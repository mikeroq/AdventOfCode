<?php 
namespace mikeroq\AdventOfCode\AdventOfCode2020\Day08;
...
final class Day08Test extends TestCase
{
    ...
    {
        $Day08 = new Day09();
        $Day08->importInput('AdventOfCode2020/Day08/test_input.txt');
    ...
    {
        $Day08 = new Day09();
        $Day08->importInput('AdventOfCode2020/Day08/input.txt');
